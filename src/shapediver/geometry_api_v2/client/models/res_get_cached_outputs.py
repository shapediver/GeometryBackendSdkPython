...
class ResGetCachedOutputs(BaseModel):
    """
    ResGetCachedOutputs
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["actions", "message", "outputs", "templates", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResGetCachedOutputs from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResGetCachedOutputs from a dict"""
        if obj is None:
            return None
