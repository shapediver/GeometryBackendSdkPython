...
class ResListModels(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResListModels from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResListModels from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "list": ResModelList.from_dict(obj["list"]) if obj.get("list") is not None else None
        })
        return _obj
