...
class ResModel(BaseModel):
    ...
    createdate: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Timestamp of creation of the model.", json_schema_extra={"examples": ["2024-05-21T14:07:35.123Z"]})
