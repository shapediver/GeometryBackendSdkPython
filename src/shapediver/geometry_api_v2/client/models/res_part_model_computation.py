...
class ResPartModelComputation(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["computations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResPartModelComputation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResPartModelComputation from a dict"""
        if obj is None:
            return None
