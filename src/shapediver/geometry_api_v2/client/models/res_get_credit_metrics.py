...
class ResGetCreditMetrics(BaseModel):
    """
    ResGetCreditMetrics
    """ # noqa: E501
    analytics: ResAnalytics = Field(description="Analytics information.")
    ...
    __properties: ClassVar[List[str]] = ["analytics", "message", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResGetCreditMetrics from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResGetCreditMetrics from a dict"""
        if obj is None:
            return None
