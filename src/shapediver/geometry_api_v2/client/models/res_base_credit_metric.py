...
class ResBaseCreditMetric(BaseModel):
    """
    ResBaseCreditMetric
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["timestamp", "isCompilationDone", "ar", "loading", "limited", "default"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResBaseCreditMetric from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResBaseCreditMetric from a dict"""
        if obj is None:
            return None
