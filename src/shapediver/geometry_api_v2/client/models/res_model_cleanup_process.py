...
class ResModelCleanupProcess(BaseModel):
    ...
    timestamp_enqueued: Annotated[str, Field(strict=True)] = Field(description="The timestamp when the deletion job has been enqueued.", json_schema_extra={"examples": ["20240521140735123"]})
    ...
    @field_validator('timestamp_enqueued', mode="before")
