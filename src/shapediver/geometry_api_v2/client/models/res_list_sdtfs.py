...
class ResListSdtfs(BaseModel):
    ...
    list: ResSdtfList
    __properties: ClassVar[List[str]] = ["message", "pagination", "version", "list"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResListSdtfs from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResListSdtfs from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "list": ResSdtfList.from_dict(obj["list"]) if obj.get("list") is not None else None
        })
        return _obj
