        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.installed:
            for _item_installed in self.installed:
                _items.append(_item_installed.to_dict() if _item_installed is not None else None)
        ...
        if self.allowed:
            for _item_allowed in self.allowed:
                _items.append(_item_allowed.to_dict() if _item_allowed is not None else None)
