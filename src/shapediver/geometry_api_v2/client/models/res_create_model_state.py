...
class ResCreateModelState(BaseModel):
    """
    ResCreateModelState
    """ # noqa: E501
    ...
    asset: Optional[ResModelStateAsset] = None
    __properties: ClassVar[List[str]] = ["modelState", "version", "asset"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResCreateModelState from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResCreateModelState from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "asset": ResModelStateAsset.from_dict(obj["asset"]) if obj.get("asset") is not None else None
        })
        return _obj
