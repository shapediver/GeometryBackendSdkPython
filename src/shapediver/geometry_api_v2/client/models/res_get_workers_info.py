...
class ResGetWorkersInfo(BaseModel):
    """
    ResGetWorkersInfo
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResGetWorkersInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResGetWorkersInfo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "system": ResWorkerSystem.from_dict(obj["system"]) if obj.get("system") is not None else None
        })
        return _obj
