...
class ResExport(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "uid", "name", "type", "dependency", "group", "order", "tooltip", "displayname", "hidden", "typeId", "typeName", "version", "delay", "content", "msg", "filename", "result", "status_computation", "status_collect"]
