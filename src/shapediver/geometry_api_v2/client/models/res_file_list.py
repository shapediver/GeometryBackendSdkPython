...
class ResFileList(BaseModel):
    """
    ResFileList
    """ # noqa: E501
    file: List[ResFileInfo] = Field(description="A directory of file objects.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResFileList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResFileList from a dict"""
        if obj is None:
            return None
