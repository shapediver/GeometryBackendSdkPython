...
class ResSdtfList(BaseModel):
    """
    ResSdtfList
    """ # noqa: E501
    file: Optional[List[ResFileInfo]] = Field(default=None, description="A directory of file objects.")
    sdtf: List[ResSdtfInfo] = Field(description="A directory of sdTF objects.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResSdtfList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResSdtfList from a dict"""
        if obj is None:
            return None
