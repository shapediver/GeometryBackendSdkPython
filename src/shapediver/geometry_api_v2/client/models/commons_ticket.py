...
class CommonsTicket(BaseModel):
    ...
    until: Annotated[str, Field(strict=True)] = Field(description="The timestamp until which the ticket should be valid.", json_schema_extra={"examples": ["20240521140735"]})
    ...
    def until_validate_regular_expression(cls, value):
        ...
        if isinstance(value, str) and not re.match(r"^\d{14}$", value):
