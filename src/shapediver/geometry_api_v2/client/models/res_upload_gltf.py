...
class ResUploadGltf(BaseModel):
    """
    ResUploadGltf
    """ # noqa: E501
    gltf: ResGltfUpload = Field(description="glTF information.")
    version: StrictStr = Field(description="Version of the Geometry Backend API.")
    __properties: ClassVar[List[str]] = ["gltf", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResUploadGltf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResUploadGltf from a dict"""
        if obj is None:
            return None
