    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.allowed_components:
            for _item_allowed_components in self.allowed_components:
                _items.append(_item_allowed_components.to_dict() if _item_allowed_components is not None else None)
        ...
        if self.disallowed_components:
            for _item_disallowed_components in self.disallowed_components:
                _items.append(_item_disallowed_components.to_dict() if _item_disallowed_components is not None else None)
