...
class ResDefaultCreditMetric(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResDefaultCreditMetric from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResDefaultCreditMetric from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "outputs": ResDefaultOutputMetric.from_dict(obj["outputs"]) if obj.get("outputs") is not None else None,
            "exports": ResDefaultExportMetric.from_dict(obj["exports"]) if obj.get("exports") is not None else None,
            "combined": ResDefaultCombinedMetric.from_dict(obj["combined"]) if obj.get("combined") is not None else None,
            "sessions": ResDefaultSessionMetric.from_dict(obj["sessions"]) if obj.get("sessions") is not None else None,
            "computations": ResDefaultComputationMetric.from_dict(obj["computations"]) if obj.get("computations") is not None else None
        })
        return _obj
