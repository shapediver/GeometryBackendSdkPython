...
class ResBase(BaseModel):
    ...
    analytics: Optional[ResAnalytics] = Field(default=None, description="Analytics information.")
    ...
    sessions: Optional[List[ResModelSession]] = Field(default=None, description="Analytics for model sessions.")
    ...
    __properties: ClassVar[List[str]] = ["asset", "list", "modelState", "system", "actions", "analytics", "auth_group", "cleanup", "decryptedTicket", "exports", "file", "gltf", "message", "model", "computations", "sessions", "outputs", "pagination", "parameters", "plugins", "sessionId", "setting", "statistic", "templates", "ticket", "version", "viewer", "viewerSettingsVersion", "warnings"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.cleanup:
            for _item_cleanup in self.cleanup:
                _items.append(_item_cleanup.to_dict() if _item_cleanup is not None else None)
        ...
        if self.exports:
            for _key_exports in self.exports:
                _field_dict[_key_exports] = self.exports[_key_exports].to_dict() if self.exports[_key_exports] is not None else None
        ...
        if self.computations:
            for _item_computations in self.computations:
                _items.append(_item_computations.to_dict() if _item_computations is not None else None)
        ...
        if self.outputs:
            for _key_outputs in self.outputs:
                _field_dict[_key_outputs] = self.outputs[_key_outputs].to_dict() if self.outputs[_key_outputs] is not None else None
        ...
        if self.parameters:
            for _key_parameters in self.parameters:
                _field_dict[_key_parameters] = self.parameters[_key_parameters].to_dict() if self.parameters[_key_parameters] is not None else None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sessions": [ResModelSession.from_dict(_item) for _item in obj["sessions"]] if obj.get("sessions") is not None else None,
            "outputs": dict(
