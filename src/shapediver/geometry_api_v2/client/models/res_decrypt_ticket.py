...
class ResDecryptTicket(BaseModel):
    """
    ResDecryptTicket
    """ # noqa: E501
    decrypted_ticket: ResTicket = Field(description="Decrypted ticket details.", alias="decryptedTicket")
    version: StrictStr = Field(description="Version of the Geometry Backend API.")
    __properties: ClassVar[List[str]] = ["decryptedTicket", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResDecryptTicket from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResDecryptTicket from a dict"""
        if obj is None:
            return None
