...
class ResOutputList(BaseModel):
    ...
    output: List[ResOutput] = Field(description="A directory of output versions.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResOutputList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResOutputList from a dict"""
        if obj is None:
            return None
