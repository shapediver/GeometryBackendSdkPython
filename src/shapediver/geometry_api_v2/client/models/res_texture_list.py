        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.model_state:
            for _item_model_state in self.model_state:
                _items.append(_item_model_state.to_dict() if _item_model_state is not None else None)
        ...
        if self.output:
            for _item_output in self.output:
                _items.append(_item_output.to_dict() if _item_output is not None else None)
            _dict['output'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in export (list)
        _items = []
        if self.export:
            for _item_export in self.export:
                _items.append(_item_export.to_dict() if _item_export is not None else None)
            _dict['export'] = _items
        ...
        if self.texture:
            for _item_texture in self.texture:
                _items.append(_item_texture.to_dict() if _item_texture is not None else None)
