...
class ResListOutputVersions(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResListOutputVersions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResListOutputVersions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "list": ResOutputList.from_dict(obj["list"]) if obj.get("list") is not None else None
        })
        return _obj
