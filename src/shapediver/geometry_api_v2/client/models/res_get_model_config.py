...
class ResGetModelConfig(BaseModel):
    """
    ResGetModelConfig
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["message", "version", "viewer"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResGetModelConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResGetModelConfig from a dict"""
        if obj is None:
            return None
