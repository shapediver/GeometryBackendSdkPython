...
class ResPartDecryptedTicket(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["decryptedTicket"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResPartDecryptedTicket from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResPartDecryptedTicket from a dict"""
        if obj is None:
            return None
