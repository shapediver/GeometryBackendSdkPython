...
class ResOutput(BaseModel):
    ...
    group: Optional[CommonsGroup] = Field(default=None, description="Group information of an output definition.")
    ...
    type_id: Optional[StrictStr] = Field(default=None, description="Type-specific ID of the output. In case of outputs defined by a single component, this corresponds to the component’s uuid.", alias="typeId")
    type_name: Optional[StrictStr] = Field(default=None, description="Type-specific name of the output. In case of outputs defined by a single component, this corresponds to the component’s name (NOT its nickname).", alias="typeName")
    ...
    __properties: ClassVar[List[str]] = ["id", "uid", "name", "material", "chunks", "dependency", "group", "order", "tooltip", "displayname", "hidden", "typeId", "typeName", "version", "delay", "content", "bbmin", "bbmax", "msg", "status_computation", "status_collect"]
