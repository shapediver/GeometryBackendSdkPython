...
class CommmonsParameterAsset(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommmonsParameterAsset from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommmonsParameterAsset from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "chunk": CommonsParameterChunk.from_dict(obj["chunk"]) if obj.get("chunk") is not None else None
        })
        return _obj
