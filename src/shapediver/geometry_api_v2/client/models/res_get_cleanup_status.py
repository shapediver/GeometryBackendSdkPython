...
class ResGetCleanupStatus(BaseModel):
    """
    ResGetCleanupStatus
    """ # noqa: E501
    cleanup: List[ResModelCleanupProcess] = Field(description="Model cleanup information.")
    version: StrictStr = Field(description="Version of the Geometry Backend API.")
    __properties: ClassVar[List[str]] = ["cleanup", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResGetCleanupStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResGetCleanupStatus from a dict"""
        if obj is None:
            return None
