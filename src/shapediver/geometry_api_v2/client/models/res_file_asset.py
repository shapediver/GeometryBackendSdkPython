...
class ResFileAsset(BaseModel):
    """
    File assets.
    """ # noqa: E501
    file: Dict[str, ResAssetDefinition] = Field(description="A directory of parameter-IDs and asset-definitions.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResFileAsset from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _field_dict = {}
        if self.file:
            for _key_file in self.file:
                _field_dict[_key_file] = self.file[_key_file].to_dict() if self.file[_key_file] is not None else None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResFileAsset from a dict"""
        if obj is None:
            return None
