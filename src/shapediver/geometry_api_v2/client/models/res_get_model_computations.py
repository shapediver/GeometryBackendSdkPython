...
class ResGetModelComputations(BaseModel):
    """
    ResGetModelComputations
    """ # noqa: E501
    computations: List[ResModelComputation] = Field(description="Statistics about model computations.")
    ...
    __properties: ClassVar[List[str]] = ["computations", "pagination", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResGetModelComputations from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResGetModelComputations from a dict"""
        if obj is None:
            return None
