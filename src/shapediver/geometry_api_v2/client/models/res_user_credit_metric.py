...
class ResUserCreditMetric(BaseModel):
    """
    ...
    user_id: StrictStr = Field(description="Requested user ID.", alias="userId")
    __properties: ClassVar[List[str]] = ["timestamp", "isCompilationDone", "ar", "loading", "limited", "default", "modelId", "userId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResUserCreditMetric from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResUserCreditMetric from a dict"""
        if obj is None:
            return None
