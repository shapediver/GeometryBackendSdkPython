...
class ReqModel(BaseModel):
    ...
    prev_id: Optional[StrictStr] = Field(default=None, description="The Model ID of the previous version of this model. This property is applicable only when creating a new model and cannot be used in conjunction with `prev_id`.")
    with_repo: Optional[StrictBool] = Field(default=None, description="If set to `true`, a new repository will be created for the model. This property is applicable only when creating a new model and cannot be used in conjunction with `prev_id`.")
    pub: Optional[StrictBool] = Field(default=None, description="Allows public access (ignore `accessdomains`).")
